...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($result->num_rows > 0) {
    ...
    if ($password== $row["password"]) { //database mei jo password hai $row[password] woh match karraha hai $password jo uper password verify function use karke built-in php ka
